clear all
tic
folder_path_without_index='D:\Users\TuanShu\160203_10x Image Stiching\160203 18_06_05(test2)_8th\';
...
X_mosaic_index_start=1;
Y_mosaic_index_start=1;

X_mosaic_number=2;%16;%3;%6;%3;%-9;%6;%3;%12;%12;
Y_mosaic_number=2;%8;%4;%8;%16;%4;%-12;%8;%4;%16;%16;
...
stiched_image_write=uint8((stiched_image_color-threshold)/(max(stiched_image_color(:))-threshold)*255);%/max(stiched_image_color(:)));
...
imwrite(stiched_image_write,[sprintf('%s_stiched_image\\',folder_path_without_index),'stiched_image_test','.png']);
%%
