...
folder_path_without_index='G:\Everday Experiements\Wide_20160301_184503_pork_after adj\';
...
if If_load_correction_file==0
    ...
    correction_B=1./correction_B_Raw_Normalized;
end
...
Lastline_pixel=488;
Lastline_ratio=1.035;
Blur_Size=30;  %size of the matrix, must be odd number
