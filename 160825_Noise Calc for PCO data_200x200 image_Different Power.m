clear all
%%
root_folder_path='F:\P1.2 Test\160825_HS4_200x200_defocus_Different Power\';
...
for r=1:length(Power_Array)
    ...
    last_folder_name=sprintf('160825_HS4_200x200_defocus_%dmW',Power_Array(r));
...
%QE_Array=0.50;
QE=0.5;
MSE_Array=zeros([length(QE_Array) 1]);
