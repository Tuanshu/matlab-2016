clear all
%%
root_folder_path='H:\P1.2 Test\160826_HS4_200x200_defocus_with C mount_4160fps_10microsec\';
...
subplot(1,1,1)
plot(Power_Array,Std_Mean_Array_1,Power_Array,Std_Mean_Array_fit);
...
dlmwrite([Data_Save_Folder 'Output_Different Power_PCO.txt'],Output,'delimiter','\t','newline','pc','precision', '%.6f');
