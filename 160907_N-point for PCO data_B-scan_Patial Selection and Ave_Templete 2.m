clear all
%%
root_folder_path='H:\PCO\160906_Illumination vs DOF\';
last_folder_name='in vivo_85_after adj 30_it225';
...
%%
    ...
    colormap(gray);
    imwrite(Reduced_Image_normalized,[Data_Save_Folder last_folder_name '_Bscan.png'],'png');
