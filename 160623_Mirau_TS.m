...
IE=1;           %interference efficiency

Ratio=0;%10;     %the ratio between sample signal and sample stray light 1:ratio

R_sample_Total=0.04;%0.01;   %The TOTAL Signal reflectance from sample
