clear all
%%
root_folder_path='G:\P1.2 Test\160826_HS4_200x200_defocus_with C mount_4160fps_2.5microsec\';
...
for r=1:length(Power_Array)
    ...
    last_folder_name=sprintf('160826_4160fps_2.432microsec_%dmW',Power_Array(r));
...
xlim([0 4096]);
ylim([0 20]);
legend('Measured',sprintf('Fitted, Estimated FWC=%g',FWC_estimated),'Location','Best');
