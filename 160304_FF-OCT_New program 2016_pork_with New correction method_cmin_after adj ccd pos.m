...
elseif correction_set == 2
    ...
    G_Ratio=6;
    Gaussian_X_width=115*G_Ratio;%350*G_Ratio;
...
Y_mosaic_starting_index=8;%+6;%+8;%+8+4;%12;%8;%17;%+8;%8;%1;
...
total_ave_frame_blur_final_text=insertText(total_ave_frame_blur_final,[0 0],'F');
