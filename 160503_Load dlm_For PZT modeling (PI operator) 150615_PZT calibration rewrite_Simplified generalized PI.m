...
% 旋轉X_bf至X_f和X_bf form a close loop
...
Index_Stric_X_f_Vbasis(end)=Index_All_X_f_Vbasis(end);    %注意這行, 目的是讓最後一個平台取最後一點
...
plot(Xbasis,X_n);      %一開始x的定義好像會對這個圖造成影響, 嘗試改變offset 好, 我終於有這個registration map了
