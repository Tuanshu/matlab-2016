...
folder_path_without_index='G:\Everday Experiements\Wide_20160304_102008_S130_R30_4x\';
...
elseif correction_set == 2
    ...
    start_index_offset_from_max=60;%16*4;
...
Gain_ratio=1.045;    %1.02 for cmin=0   1.045 for cmin=5
...
%%  這只是用來測試用的, 實際上設定是在後半
Lastline_ratio=1.075;       %正確值為1.045 for cmin=0 1.075 for cmin=5
