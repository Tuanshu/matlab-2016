clear all
%%
root_folder_path='I:\161226_e2v EM1 test';
%root_folder_path='I:\161223_e2v EM1\CeYAG\Different Exp Time';

Data_Name='161226_e2v EM1 test';
Current_Array=[8];%[3:3:24];
it=210;
...
for p=1:length(Current_Array)
    file_name=sprintf('no.%g tissue measurement_it%g',Current_Array(p),it);
...
Data_Image_Npoint_normalized=(Data_Image_Reduced-C_min)/(C_max-C_min);
