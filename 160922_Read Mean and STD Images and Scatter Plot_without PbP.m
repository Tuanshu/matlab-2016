...
if strcmp(Model,'Mikrotron-Previous')
    Fit_Range=[1 1100];
...
hold on
plot(Mean_All_Array_Sort*Bin_Adj_Factor,(STD_All_Array_fit).^2,'-','LineWidth',3,'Color',Color_Matrix(Default_Color_Index,:));
text(max(Mean_All_Array_Sort*Bin_Adj_Factor)*0.8,max((STD_All_Array_fit).^2)*0.8,['\leftarrow' Model],'FontSize',18)
