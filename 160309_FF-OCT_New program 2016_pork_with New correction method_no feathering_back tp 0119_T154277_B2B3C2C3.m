...
folder_path_without_index='G:\Everday Experiements\160218_Temp_Wide Scan_T154277_B2B3C2C3_S110_R50_4X\';
...
elseif correction_set == 2
    ...
    if_glass_interface_searching=1;
    start_index_offset_from_max=0;%+8*2;%+9*4;%16*4;
...
elseif correction_set == 3  %for 1x
    ...
    if_glass_interface_searching=1;
    start_index_offset_from_max=32;%+9*4;%16*4;
...
X_mosaic_number=6;%12;%12;%3;%6;%3;%-9;%6;%3;%12;%12;
