...
folder_path_without_index='G:\Everday Experiements\160218_Temp_Wide Scan_T154277_A4_S110_R30_4X\';
...
X_mosaic_starting_index=0;%6;%13;%+6;%6;%1;  %start from 0
Y_mosaic_starting_index=24;%12;%8;%17;%+8;%8;%1;


X_mosaic_number=6;%12;%3;%6;%3;%-9;%6;%3;%12;%12;
Y_mosaic_number=8;%16;%4;%8;%16;%4;%-12;%8;%4;%16;%16;
...
for NNN=1:total_stack_number
    ...
    %% Patial
    X_start=1100;   %1: 1050 2: 1100    3: 2235     4: 1050
    Y_start=1375;   %1: 875 2: 1375     3: 2950     4: 2940
    X_size=800;
    Y_size=X_size/3*4;
...
Y_start=2940;   %1: 875 2: 1375     3: 2950     4: 2940
X_size=800;
Y_size=X_size/3*4;
...
%%
imwrite(stiched_image_rotated,[sprintf('%s_stiched_image\\',folder_path_without_index),sprintf('stiched_image_offset%.1f micron_X%d_Y%d_rotated',(start_index_offset_from_max+(NNN-1)*stack_sampling_spacing)*0.2,X_mosaic_starting_index,Y_mosaic_starting_index),'.png']);
imwrite(stiched_image_rotated_patial,[sprintf('%s_stiched_image\\',folder_path_without_index),sprintf('stiched_image_offset%.1f micron_X%d_Y%d_rotated',(start_index_offset_from_max+(NNN-1)*stack_sampling_spacing)*0.2,X_mosaic_starting_index,Y_mosaic_starting_index),'.png']);
