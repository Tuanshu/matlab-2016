...
for p=1:length(Ratio_System)
    ...
    T_StrayLight=T1.*T2.*R_sample_stray.*T2.*T1;  %the overall T of Mirau for Sample path
    T_StrayLight_System=T1.*R2.*T1*Ratio_System(p);  %Direct reflection from the GP2
