...
folder_path_without_index='G:\Everday Experiements\WideScan_20160316_163444_15-33455a_C3_S70_R65_blaken_1x\';
...
elseif correction_set == 2
    ...
    if_glass_interface_searching=1;
    start_index_offset_from_max=200-16*5;%+8*8;%300;%+9*4;%16*4;
    ...
    cmax_2=15;%30;  %without Dark frame 0.25;     %B1:0.55   P1.1_vib:0.4  C3_not blacken: 0.4
    G_Ratio=10;
    Gaussian_X_width=25*G_Ratio;%350*G_Ratio;
    Gaussian_Y_width=100*G_Ratio;%250*G_Ratio;
    Modulation_depth_X=1;%1 for max, -1 for min
    Modulation_depth_Y=0;%1 for max, -1 for min
    X_offset=0;%160;
    Y_offset=0;%-100;
...
X_mosaic_starting_index=12;%+2;%+6;%+6;%+6+3;%+6;%6;%13;%+6;%6;%1;  %start from 0
Y_mosaic_starting_index=16;%+2;%+8+4;%+6;%+8;%+8+4;%12;%8;%17;%+8;%8;%1;


X_mosaic_number=6;%6;%6;%12;%12;%3;%6;%3;%-9;%6;%3;%12;%12;
Y_mosaic_number=8;%8;%16;%8;%16;%4;%8;%16;%4;%-12;%8;%4;%16;%16;
...
for NNN=1:total_stack_number
    ...
    if If_patial==1
      %% Rotate   
        ...
        %% Patial
        X_start_array=[750 975 2150 2325 2310 2135 2085 1885 2035 1660 835 1435];   %12: 1435   11: 835    10: 1660   9: 2035 8: 1885    7: 2085    6: 2135 5:2310 1: 750 2: 975    3: 2150     4: 2325
        Y_start_array=[550 525 250 700 1225 1750 2000 2075 2250 2250 1700 2600];   %12: 2600   11: 1700   10: 2250   9: 2250 8: 2075    7: 2000    6: 1750 5:1225 1: 550 2: 525     3: 250     4: 700
        X_size=800;
        Y_size=X_size/3*4;
