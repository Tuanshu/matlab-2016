...
map_method='std';  %mean std kurtosis skewness diff
    ...
    start_index_offset_from_max=20;%+9*4;%16*4;
...
elseif correction_set == 2
    ...
    if_glass_interface_searching=1;
    start_index_offset_from_max=40;%+9*4;%16*4;
...
elseif correction_set == 3  %for 1x
    ...
    if_glass_interface_searching=1;
    start_index_offset_from_max=72;%+9*4;%16*4;
...
X_mosaic_starting_index=6;%+3;%+6;%+6;%+6+3;%+6;%6;%13;%+6;%6;%1;  %start from 0
