...
dxdv=sdxdv_measured_forward;%./(rand(length(vth_array),1)*0.1+ones([length(vth_array) 1])-0.05);
...
MSE_B=99999999;
MSE_total=99999999;
clear MSE_record MSE_sdxdv_for_record MSE_sdxdv_bak_record
while (Current_Loop<Max_Number_of_Loop) && (MSE_total>MSE_total_OK)
    ...
    d_sdxdv_for_d_dxdv = (sdxdv_for(S,dxdv+d_dxdv)-sdxdv_for(S,dxdv))/d_dxdv;
    d_sdxdv_bak_d_dxdv = (sdxdv_bak(S,dxdv+d_dxdv)-sdxdv_bak(S,dxdv))/d_dxdv;
    ...
    while (GO>0)
        if GO==1    %for lambda
            Q1=d_sdxdv_for_d_S+lambda/v*d_sdxdv_for_d_S;
            Q2=d_sdxdv_for_d_dxdv;
            Q3=d_sdxdv_bak_d_S;
            Q4=d_sdxdv_bak_d_dxdv+lambda/v*d_sdxdv_bak_d_dxdv;
            increment_S = det_array(delta_sdxdv_for,Q2,delta_sdxdv_bak,Q4)./det_array(Q1,Q2,Q3,Q4);
            increment_dxdv = det_array(Q1,delta_sdxdv_for,Q3,delta_sdxdv_bak)./det_array(Q1,Q2,Q3,Q4);
            ...
            dxdv_temp=dxdv+0.1*increment_dxdv;
                        
            S_temp(isnan(S_temp))=S_pre(isnan(S_temp));
            S_temp(isinf(S_temp))=S_pre(isinf(S_temp));
            dxdv_temp(isnan(dxdv_temp))=dxdv_pre(isnan(dxdv_temp));
            dxdv_temp(isinf(dxdv_temp))=dxdv_pre(isinf(dxdv_temp));
            
            
            delta_sdxdv_for_temp=sdxdv_for_m-sdxdv_for(S_temp,dxdv_temp);
            delta_sdxdv_bak_temp=sdxdv_bak_m-sdxdv_bak(S_temp,dxdv_temp);
            
            MSE_total_temp(1)=(sum((delta_sdxdv_for_temp./sdxdv_for_m).^2)/length(delta_sdxdv_for_temp)+sum((delta_sdxdv_bak_temp./sdxdv_bak_m).^2)/length(delta_sdxdv_bak_temp)).^0.5;
        ...
        elseif GO==2    %for lambda/v
            Q1=d_sdxdv_for_d_S+lambda*d_sdxdv_for_d_S;
            Q2=d_sdxdv_for_d_dxdv;
            Q3=d_sdxdv_bak_d_S;
            Q4=d_sdxdv_bak_d_dxdv+lambda*d_sdxdv_bak_d_dxdv;
            increment_S = det_array(delta_sdxdv_for,Q2,delta_sdxdv_bak,Q4)./det_array(Q1,Q2,Q3,Q4);
            increment_dxdv = det_array(Q1,delta_sdxdv_for,Q3,delta_sdxdv_bak)./det_array(Q1,Q2,Q3,Q4);
                        %dthickness = det_array(Q1,Q2,delta_A,Q4,Q5,delta_B,Q7,Q8,delta_C)./det_array(Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9);
                        %嘗試用MATLAB的左除法
                        %increment=[d_sdxdv_for_d_S d_sdxdv_for_d_dxdv;d_sdxdv_bak_d_S d_sdxdv_bak_d_dxdv].\[delta_sdxdv_for;delta_sdxdv_bak];
            S_temp=S+0.1*increment_S;
            dxdv_temp=dxdv_temp+0.1*increment_dxdv;
            ...
            MSE_total_temp(2)=(sum((delta_sdxdv_for_temp./sdxdv_for_m).^2)/length(delta_sdxdv_for_temp)+sum((delta_sdxdv_bak_temp./sdxdv_bak_m).^2)/length(delta_sdxdv_bak_temp)).^0.5;
            ...
            Q1=d_sdxdv_for_d_S+lambda*(v^w)*d_sdxdv_for_d_S;
            Q2=d_sdxdv_for_d_dxdv;
            Q3=d_sdxdv_bak_d_S;
            Q4=d_sdxdv_bak_d_dxdv+lambda*(v^w)*d_sdxdv_bak_d_dxdv;
            increment_S = det_array(delta_sdxdv_for,Q2,delta_sdxdv_bak,Q4)./det_array(Q1,Q2,Q3,Q4);
            increment_dxdv = det_array(Q1,delta_sdxdv_for,Q3,delta_sdxdv_bak)./det_array(Q1,Q2,Q3,Q4);
                        %dthickness = det_array(Q1,Q2,delta_A,Q4,Q5,delta_B,Q7,Q8,delta_C)./det_array(Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9);
                        %嘗試用MATLAB的左除法
            ...
            MSE_total_temp(GO)=(sum((delta_sdxdv_for_temp./sdxdv_for_m).^2)/length(delta_sdxdv_for_temp)+sum((delta_sdxdv_bak_temp./sdxdv_bak_m).^2)/length(delta_sdxdv_bak_temp)).^0.5;
...
subplot(2,1,1)
plot(sdxdv_for(S,dxdv));
subplot(2,1,2)
plot(sdxdv_bak(S,dxdv));
