...
folder_path_without_index='G:\Everday Experiements\WideScan_20160317_085507_15-11679_C2C3D2D3_S55_R70\';
...
elseif correction_set == 2
    ...
    cmin_2=1.5;%1;   %B1:0.025   P1.1_vib:0   C3_not blacken: 0
    cmax_2=10;%8;  %without Dark frame 0.25;     %B1:0.55   P1.1_vib:0.4  C3_not blacken: 0.4
    G_Ratio=10;
    Gaussian_X_width=230*G_Ratio;%350*G_Ratio;
    Gaussian_Y_width=100*G_Ratio;%250*G_Ratio;
    Modulation_depth_X=0;%1 for max, -1 for min
...
Y_mosaic_starting_index=8+4;%+8+4;%+6;%+8;%+8+4;%12;%8;%17;%+8;%8;%1;
