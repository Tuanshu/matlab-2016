clear all
%%
Save_File_Name='161028_TiSa test_with Y Ave';
root_folder_path='F:\TiSapphire\161026_Imperx_LineField Test\sample\';
last_folder_name=[48 61 62 63 64 65 66 69 70 71 73 74 76 77 78 79 80 84 85 86];

If_EffMap=0;
If_Norm=1;
Data_Save_Folder='F:\Demo\';
...
%%
    ...
    elseif If_EffMap ==0
        imwrite(Reduced_Image_normalized,[Processed_Data_Path sprintf('_Bscan_Axial_ave_Factor_%d.png',Axial_ave_Factor)],'png');
    elseif If_EffMap ==-1
