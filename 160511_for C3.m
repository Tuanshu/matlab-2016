...
cd('C:\Users\user\Desktop\AMO Software System Control eric modify\Temp\WideScan_20160524_084457_S65_R30_16X_C3\');
...
total_stack_number=1;%10;%20;%20;%40;


if correction_set == 0  %15-21005
    System=2;       %1 for P1.1, 2 for B1
    if_glass_interface_searching=1;
    folder_path_without_index='C:\Users\user\Desktop\AMO Software System Control eric modify\Temp\WideScan_20160524_084457_S65_R30_16X_C3\';


    X_incre=0;%-45.7000;%19.0844
    Y_incre=0;%-6.6429;%-33.4857
    ...
    X_mosaic_starting_index_min=12;%12;
    ...
    X_mosaic_starting_index=12;%12;%+3;%+2;%+6;%+6;%+6+3;%+6;%6;%13;%+6;%6;%1;  %start from 0
...
%% Search for 4 point's z
if If_autotilt

% identify FOV index
tic
Corner_X_array=[X_mosaic_starting_index_min X_mosaic_starting_index_min X_mosaic_starting_index_min+X_mosaic_number_max-1 X_mosaic_starting_index_min+X_mosaic_number_max-1 X_mosaic_starting_index_min+round(X_mosaic_number_max/2)];
Corner_Y_array=[Y_mosaic_starting_index_min Y_mosaic_starting_index_min+Y_mosaic_number_max-1 Y_mosaic_starting_index_min Y_mosaic_starting_index_min+Y_mosaic_number_max-1 Y_mosaic_starting_index_min+round(Y_mosaic_number_max/2)];


frame_mean=zeros(num_of_frame_per_division*length(Division_array),4);
...
Depth_micron=0.2*[1:length(frame_mean)]';
 Z_max_index=ones([4 1]);
 Z_max_value=ones([4 1]);
% calculate max
% for p=1:5
...
%% Calc Xinc and Yinc
    ...
    Y=Depth_micron(Z_max_index);%-min(Z_max_Pos);
