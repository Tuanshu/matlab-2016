...
%%
Data=dlmread('160125_Wide scan near 5V.txt');        
plot(Data(:,2));
...
[minvalue minindex]=findpeaks(Voltage_invert,'MINPEAKDISTANCE',5000,'MINPEAKHEIGHT',End_Voltage-8);
[maxvalue maxindex]=findpeaks(Voltage_for_turningpoint,'MINPEAKDISTANCE',5000,'MINPEAKHEIGHT',End_Voltage-8);
