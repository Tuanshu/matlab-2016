...
elseif correction_set == 2
    ...
    cmin_1=0;
    cmax_1=30;
    cmin_2=0.4;%0.45;%12;%11
    cmax_2=0.6;%0.85;%16;%60;%120;%20;
    G_Ratio=10;
...
X_mosaic_starting_index=12;%+6+3;%+6;%6;%13;%+6;%6;%1;  %start from 0
Y_mosaic_starting_index=8;%+8+4;%+6;%+8;%+8+4;%12;%8;%17;%+8;%8;%1;


X_mosaic_number=3;%12;%3;%6;%3;%-9;%6;%3;%12;%12;
Y_mosaic_number=4;%16;%4;%8;%16;%4;%-12;%8;%4;%16;%16;
...
%%  這只是用來測試用的, 實際上設定是在後半
Lastline_ratio=1.045;       %正確值為1.045
...
dlmwrite([sprintf('%s_correction_file\\',folder_path_without_index),'correction_file_marker.txt'],total_ave_frame_blur_final_marked,'delimiter','\t','newline','pc','precision', '%.6f');
end
%%
fclose all