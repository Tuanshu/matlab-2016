clear all
%%
Second_last_folder_name='160909_Final Test\Different Exposure Time (Perfect Dark)';

root_folder_path=['H:\PCO\' Second_last_folder_name '\'];
Data_Save_Folder=['F:\Processed Data\' Second_last_folder_name '\'];

mkdir(Data_Save_Folder);

Power_Array=[0 100:100:900];
If_smooth=0;
...
for r=1:length(Power_Array)
    ...
    last_folder_name=sprintf('it%d',Power_Array(r));
    last_folder_name_save=sprintf('it%d',Power_Array(r));
