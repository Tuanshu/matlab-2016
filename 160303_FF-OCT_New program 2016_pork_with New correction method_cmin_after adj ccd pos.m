...
folder_path_without_index='G:\Everday Experiements\Wide_20160303_161048_pork_adj ccd pos_it3200_another pos\';
...
elseif correction_set == 2
    ...
    Gaussian_Y_width=150*G_Ratio;%250*G_Ratio;
    Modulation_depth_X=1;%1 for max, -1 for min
    Modulation_depth_Y=-1;%1 for max, -1 for min
    X_offset=0;%160;
    Y_offset=0;%-100;
