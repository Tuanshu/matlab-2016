...
folder_path_without_index='G:\Everday Experiements\Wide_20160308_110428_R60_4x_15-5609VD\';
...
if correction_set == 1
    ...
    Modulation_depth_Y=1;%1 for max, -1 for min
    X_offset=10;
    Y_offset=20;
...
X_mosaic_starting_index=6;%+6+3;%+6;%6;%13;%+6;%6;%1;  %start from 0
Y_mosaic_starting_index=8;%+8+4;%+6;%+8;%+8+4;%12;%8;%17;%+8;%8;%1;


X_mosaic_number=12;%12;%12;%3;%6;%3;%-9;%6;%3;%12;%12;
Y_mosaic_number=8;%8;%16;%4;%8;%16;%4;%-12;%8;%4;%16;%16;
...
for NNN=1:total_stack_number
    ...
    for N=0:(total_FOV_number-1)
        ...
        if strcmp(map_method,'mean')==1
            ...
            total_ave_frame=total_ave_frame+Averaged_frame/max(Averaged_frame(:));
            total_ave_frame_after_correction=total_ave_frame_after_correction+Averaged_frame/max(Averaged_frame(:)).*correction_B;
...
TH=0.4;
pixel_TH=50;
stiched_image_write_BW=im2bw(stiched_image_write,TH);

stiched_image_write_BW_final=bwareaopen(stiched_image_write_BW,pixel_TH);
