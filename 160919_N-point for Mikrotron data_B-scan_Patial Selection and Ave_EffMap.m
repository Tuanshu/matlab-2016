clear all
%%
root_folder_path='F:\Mikrotron\160919_in vivo\';
last_folder_name='1';
...
for QQQ=1:length(ave_factor)
    ...
    if If_EffMap ==1
        Processed_Data_Path=[Data_Save_Folder '160919_in vivo test' last_folder_name sprintf('_EffMap_Ave_Factor_%d.raw',ave_factor(QQQ))];
    elseif If_EffMap ==0
        Processed_Data_Path=[Data_Save_Folder '160919_in vivo test' last_folder_name sprintf('_Ave_Factor_%d.raw',ave_factor(QQQ))];
    elseif If_EffMap ==-1
        Processed_Data_Path=[Data_Save_Folder '160919_in vivo test' last_folder_name sprintf('Test_Ave_Factor_%d.raw',ave_factor(QQQ))];
    end
    %%
...
%%
    ...
    if If_EffMap ==1
        imwrite(Reduced_Image_normalized,[Data_Save_Folder '160919_in vivo test' last_folder_name '_Bscan_EffMap.png'],'png');
    elseif If_EffMap ==0
        imwrite(Reduced_Image_normalized,[Data_Save_Folder '160919_in vivo test' last_folder_name '_Bscan.png'],'png');
    elseif If_EffMap ==-1
        imwrite(Reduced_Image_normalized,[Data_Save_Folder '160919_in vivo test' last_folder_name '_Bscan_Test.png'],'png');
    end
