...
folder_path_without_index='G:\Everday Experiements\WideScan_20160316_123341_15-21005_C2D2_S50_R60\';
...
elseif correction_set == 2
    ...
    if_glass_interface_searching=1;
    start_index_offset_from_max=60;%300;%+9*4;%16*4;
...
X_mosaic_starting_index=12+3;%+6;%+6;%+6+3;%+6;%6;%13;%+6;%6;%1;  %start from 0
Y_mosaic_starting_index=8;%+8+4;%+6;%+8;%+8+4;%12;%8;%17;%+8;%8;%1;


X_mosaic_number=6;%6;%12;%12;%3;%6;%3;%-9;%6;%3;%12;%12;
Y_mosaic_number=8;%16;%8;%16;%4;%8;%16;%4;%-12;%8;%4;%16;%16;
