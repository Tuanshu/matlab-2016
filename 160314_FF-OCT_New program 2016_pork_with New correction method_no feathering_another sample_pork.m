...
folder_path_without_index='G:\Everday Experiements\Wide_20160311_233732_pork_R70_1x\';
...
elseif correction_set == 2
    ...
    if_glass_interface_searching=1;
    start_index_offset_from_max=160;%300;%+9*4;%16*4;
...
X_mosaic_starting_index=6+2;%+6;%+6;%+6+3;%+6;%6;%13;%+6;%6;%1;  %start from 0
