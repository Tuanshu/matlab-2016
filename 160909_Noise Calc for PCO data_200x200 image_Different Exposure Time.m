clear all
%%
root_folder_path='F:\PCO\160909_Final Test\Different Exposure Time (Perfect Dark)\';

ExpTime_Array=[0:100:900];
...
for r=1:length(ExpTime_Array)
    ...
    last_folder_name=sprintf('it%d',ExpTime_Array(r));
    folder_path=[root_folder_path last_folder_name '\'];

    Data_Save_Folder='H:\Processed Data\';
