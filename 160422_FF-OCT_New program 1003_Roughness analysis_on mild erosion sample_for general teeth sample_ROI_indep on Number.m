...
if If_load_data == 1
    ...
    dlmwrite([Training_Data_Storage_Folder_Path,sprintf('Set_%d_Second_Map.txt',set)],Second_Map,'delimiter','\t','newline','pc','precision', '%.6f');
...
for p=1:kk
    ...
    Current_Data=[mean(Current_Superpixel_First) max(Current_Superpixel_First)-min(Current_Superpixel_First)];
